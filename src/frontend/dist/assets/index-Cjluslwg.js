const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-CjacEaHS.js","assets/proxy-Ceh10oOd.js","assets/signup-pjCYI0Xz.js","assets/shield-check-Dh0sBpTe.js","assets/dashboard-ApNwRZYQ.js"])))=>i.map(i=>d[i]);
...
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./login-CjacEaHS.js"), true ? __vite__mapDeps([0,1]) : void 0));
const SignupPage = reactExports.lazy(() => __vitePreload(() => import("./signup-pjCYI0Xz.js"), true ? __vite__mapDeps([2,1,3]) : void 0));
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./dashboard-ApNwRZYQ.js"), true ? __vite__mapDeps([4,1,3]) : void 0));
const queryClient$1 = new QueryClient({
  defaultOptions: { queries: { staleTime: 3e4 } }
});
function RootRedirect() {
  const isAuthenticated = useAuthStore((s) => s.isAuthenticated);
  return isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/dashboard" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/login" });
}
...
const loginRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/login",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {}) })
});
const signupRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/signup",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SignupPage, {}) })
});
const dashboardRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/dashboard",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardPage, {}) }) })
});
...
export {
  ...
  React$4 as b,
  createStore as c,
  useSyncExternalStoreExports as d,
